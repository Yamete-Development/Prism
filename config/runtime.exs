...
config :prism,
  ...
  retry_max_batches_per_sec: String.to_integer(System.get_env("PRISM_RETRY_MAX_BATCHES_PER_SEC") || "50"),
  retry_broadway_concurrency: String.to_integer(System.get_env("PRISM_RETRY_BROADWAY_CONCURRENCY") || "50"),
