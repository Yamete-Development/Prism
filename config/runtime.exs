...
config :prism,
  ...
  broadway_concurrency: String.to_integer(System.get_env("PRISM_BROADWAY_CONCURRENCY") || "8"),
  batch_max_concurrency: String.to_integer(System.get_env("PRISM_BATCH_MAX_CONCURRENCY") || "20"),
